...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'basicauth_user', 'username', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20))

        # Changing field 'User.password'
        db.alter_column(u'basicauth_user', 'password', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'User.username'
        db.alter_column(u'basicauth_user', 'username', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True))

        # Changing field 'User.password'
        db.alter_column(u'basicauth_user', 'password', self.gf('django.db.models.fields.CharField')(max_length=32))

    models = {
        u'basicauth.group': {
            'Meta': {'object_name': 'Group'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 20, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
