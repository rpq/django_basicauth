...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.verify_id'
        db.add_column(u'basicauth_user', 'verify_id',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'User.verified'
        db.add_column(u'basicauth_user', 'verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.verify_id'
        db.delete_column(u'basicauth_user', 'verify_id')

        # Deleting field 'User.verified'
        db.delete_column(u'basicauth_user', 'verified')
    ...
    models = {
        ...
        u'basicauth.user': {
            ...
            'verify_id': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        },
